/**
 * This was taken from the SST documentation: https://docs.sst.dev/going-to-production#stacks-setup
 */
...
export function GitHubOpenId({ app, stack }: StackContext) {
  if (app.stage === 'prod') {
    ...
    const organization = 'Ticket-Avengers-Inc' // Use your GitHub organization
    const repository = 'driven-app' // Use your GitHub repository
